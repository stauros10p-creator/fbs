    ...
    <div className="min-h-full">
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            <button onClick={() => navigate('/ops/inbound')} className="btn-secondary text-xs flex items-center gap-1.5">
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="panel flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            <label className="text-xs text-muted font-medium uppercase tracking-wider">Από:</label>
            <input
              type="date"
              value={dateFrom}
          ...
          <div className="flex items-center gap-2">
            <label className="text-xs text-muted font-medium uppercase tracking-wider">Έως:</label>
            <input
              type="date"
              value={dateTo}
