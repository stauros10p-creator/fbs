...
import { BarChart2, TrendingUp, Activity, Clock, ChevronRight, CalendarCheck, PackageOpen, Radio, GitCompareArrows, RotateCcw } from 'lucide-react'
...
const REPORTS: ReportCard[] = [
  ...
  },
  {
    to: '/ops/epistrofes',
    Icon: RotateCcw,
    label: 'Επιστροφές: Δηλωθείσες vs Παραλαβές',
    description: 'Σύγκριση δηλωθέντων επιστροφών με πραγματικές παραλαβές ret ανά ημέρα, με επιλογή εύρους ημερομηνιών',
    tags: ['Επιστροφές', 'Ret', 'Σύγκριση', 'Εύρος'],
